...
Dari tabel yang terlihat menunjukkan bahwa model Gradient Boosting memiliki performa terbaik dengan MAE dan RMSE paling rendah serta R² Score tertinggi (0.6647). Sebaliknya, SVR (RBF Kernel) memiliki R² Score negatif dan kesalahan terbesar, menandakan model tersebut tidak cocok untuk dataset ini.
"""
